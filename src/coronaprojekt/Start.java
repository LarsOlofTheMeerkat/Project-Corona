...
private static InfDB minDatabaskoppling;
    ...
    public static void main(String[] args) {
        try{
            ...
            //new KalenderGUI(minDatabaskoppling).setVisible(true);
            //new KallaTillMote(minDatabaskoppling,9).setVisible(true);
            //new SvaraPaMote(minDatabaskoppling,14,"virusspridning").setVisible(true);
            new MotenJagSkapat(minDatabaskoppling,9).setVisible(true);
